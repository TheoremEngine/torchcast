...
class CriteriaTest(unittest.TestCase):
    ...
    def test_mse_loss(self):
        ...
        loss.backward()
        sb_1 = torch.tensor([[0., 0., 0.], [0., -2., -3.]])
        self.assertTrue(torch.isclose(x_1.grad, sb_1).all())
        sb_2 = torch.tensor([[0., 0., 0.], [0., 2., 3.]])
        self.assertTrue(torch.isclose(x_2.grad, sb_2).all())
        ...
        loss.backward()
        sb_1 = torch.tensor([[0., 0., 0.], [0., -4., -6.]])
        self.assertTrue(torch.isclose(x_1.grad, sb_1).all())
        sb_2 = torch.tensor([[0., 0., 0.], [0., 4., 6.]])
        self.assertTrue(torch.isclose(x_2.grad, sb_2).all())
    ...
    def test_smooth_l1_loss(self):
        ...
        loss.backward()
        sb_1 = torch.tensor([[0., 0., 0.], [0., -0.5, -0.5]])
        self.assertTrue(torch.isclose(x_1.grad, sb_1).all())
        sb_2 = torch.tensor([[0., 0., 0.], [0., 0.5, 0.5]])
        self.assertTrue(torch.isclose(x_2.grad, sb_2).all())
        ...
        loss.backward()
        sb_1 = torch.tensor([[0., 0., 0.], [0., -1.0, -1.0]])
        self.assertTrue(torch.isclose(x_1.grad, sb_1).all())
        sb_2 = torch.tensor([[0., 0., 0.], [0., 1.0, 1.0]])
        self.assertTrue(torch.isclose(x_2.grad, sb_2).all())
        ...
        x_1.requires_grad = x_2.requires_grad = True
        x_1.retain_grad(), x_2.retain_grad()
        loss = tc.nn.smooth_l1_loss(x_1, x_2)
        self.assertEqual(loss.item(), 0)
        loss.backward()
        self.assertTrue((x_1.grad == 0).all())
        self.assertTrue((x_2.grad == 0).all())
